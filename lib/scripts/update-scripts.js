...
fs.readdirSync(path.resolve('src', 'styles', 'colorschemes')).forEach((c) => {
    ...
    scripts[`serve:${scheme}`] = `cross-env CAWEB_NODE_OPTIONS='--scheme' webpack serve --config ./node_modules/@caweb/webpack/webpack.config.js ./lib/entry/${scheme}.js ./node_modules/@caweb/webpack/tests/webpack.tests.js --merge`;
